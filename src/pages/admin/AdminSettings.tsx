...
import { Shield, Bell, Globe, CreditCard, Mail, Loader } from "lucide-react";
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Require a verification code for every admin login. This is highly recommended.</p>
                </div>

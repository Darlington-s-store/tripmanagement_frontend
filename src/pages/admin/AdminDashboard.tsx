...
import { adminService, AdminDashboardStats, User, Listing } from "@/services/admin";
...
const bookingData = [
  { month: 'Jan', bookings: 2, projections: 3 },
  { month: 'Feb', bookings: 4, projections: 5 },
  { month: 'Mar', bookings: 3, projections: 4 },
  { month: 'Apr', bookings: 5, projections: 6 },
  { month: 'May', bookings: 8, projections: 7 },
  { month: 'Jun', bookings: 12, projections: 10 },
  { month: 'Jul', bookings: 9, projections: 11 },
  { month: 'Aug', bookings: 7, projections: 9 },
  { month: 'Sep', bookings: 10, projections: 12 },
  { month: 'Oct', bookings: 15, projections: 14 },
  { month: 'Nov', bookings: 18, projections: 17 },
  { month: 'Dec', bookings: 14, projections: 15 },
];

const revenueSplit = [
  { name: 'Hotels & Stays', value: 72, color: '#f97316' },
  { name: 'Transportation', value: 28, color: '#94a3b8' },
];
      ...
      <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm flex flex-col">
            <h3 className="mb-6 font-display text-lg font-bold">Revenue Split</h3>
            <div className="relative flex-1 flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-2xl font-bold font-display">$84K</span>
